...
Tourism Server – Error & Success Response Rules

These rules define the ONLY allowed way to return success and error responses from the Tourism Server API. All AI assistants (Claude / Windsurf / GPT) MUST follow this contract strictly.
...
code must be a stable machine-readable string (for example TOUR_NOT_FOUND)
