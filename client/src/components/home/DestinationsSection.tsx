...
export const DestinationsSection = () => {
    ...
    return (
        <section className="py-24 container mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-10 text-center text-gradient leading-tight pb-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 h-auto md:h-[600px]">
                {destinations.map((dest, index) => (
                    ...
                    >
                        ...
                        <div className="absolute bottom-6 left-6 text-white p-4 z-10">
                            <h3 className="text-2xl font-bold mb-1 transform transition-transform duration-300 group-hover:-translate-y-1 leading-tight pb-1">
                                {dest.name}
                            </h3>
